...
const maps = {
  global: [
    { alias: "<Ctrl-z>", map: "<Alt-i>", description: "ignore mode (escape to exit)" },
    { alias: "K", map: "E", description: "tab focus left" },
    { alias: "J", map: "R", description: "tab focus right" },
    { alias: "H", map: "S", description: "back in history" },
    { alias: "L", map: "D", description: "forward in history" },
    { alias: "F", map: "gf", description: "open link in new tab without focus" },
    { alias: "p", map: "<Alt-p>", description: "pin tab (toggle)" },
    { alias: "m", map: "<Alt-m>", description: "mute tab (toggle)" },
    { alias: "d", map: "x", description: "close tab" },
    { alias: "u", map: "X", description: "restore closed tab" },
    {
      alias:       "gi",
      description: "Go To Edit Box",
      callback:    actions.gotoEditBox,
    },
    {
      alias:       "ym",
      description: "Copy Current url as markdown",
      callback:    actions.copyMarkdownLinkText,
    },
    {
      alias:       "<Ctrl-p>",
      description: "Open Clipboard URL in current tab",
      callback:    actions.openClipUrl,
    },
    {
      alias:       ";se",
